...
const (
	...
	// WS_OVERLAPPEDWINDOW | WS_VISIBLE: a plain top-level window, mapped. The
	// overlay's own styles are layered and click-through, which is the one
	// thing a window meant to receive input must not be.
