...
func (o *winOverlay) drawRecursiveLabelBackground(
	...
	// rattles around in. Scaled too, because the label drawn over this box goes
	// through drawTextCentered, which scales the same font size.
	fontSize := style.LabelFontSizeIn(label, cell, 1) * o.scale()
