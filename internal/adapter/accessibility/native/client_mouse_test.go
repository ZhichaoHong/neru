...
// releaseHeldCall is what stubMouse records when ensureMouseUp runs.
const releaseHeldCall = "release_held"
...
func stubMouse(t *testing.T, held bool) *[]string {
	...
	ensureMouseUp = func() { record(releaseHeldCall) }
...
func TestClickReleasesAHeldButtonFirst(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want:       []string{releaseHeldCall, "left_click"},
		},
		{
			name:       "right click",
			actionType: action.TypeRightClick,
			want:       []string{releaseHeldCall, "right_click"},
		},
		{
			name:       "middle click",
			actionType: action.TypeMiddleClick,
			want:       []string{releaseHeldCall, "middle_click"},
		},
	}
