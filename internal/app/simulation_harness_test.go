...
// labeled, sorted, so a journey can state which part of the desktop was hinted
...
//
// Mission Control is honored here rather than ignored because it belongs to the
